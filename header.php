		...
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div class="logo_container">
					...
					<!-- Vi har udkommenteret/fjernet
					
					<a href="<?php // echo esc_url( home_url( '/' ) ); ?>"
					
					for så at få vores logo til at linke til vores forside. Før når man trykkede på logoet, loade den siden igen.-->
					
					<a href="#ForsideSection">
